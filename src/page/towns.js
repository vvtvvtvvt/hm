...
window.addEventListener('load', function() {
    ...
    /**
     * Функция должна загружать список городов
     * из https://raw.githubusercontent.com/smelukov/citiesTest/master/cities.json
    ...
    let errorBtn = homeworkContainer.querySelector('#error-block-btn');
